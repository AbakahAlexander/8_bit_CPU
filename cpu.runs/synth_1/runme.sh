...
HD_PWD='C:/Users/abaka/cpu/cpu.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log multicore_microprocessor.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source multicore_microprocessor.tcl
