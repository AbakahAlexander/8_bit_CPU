...
HD_PWD='C:/Users/abaka/cpu/cpu.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log multicore_microprocessor.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source multicore_microprocessor.tcl -notrace
